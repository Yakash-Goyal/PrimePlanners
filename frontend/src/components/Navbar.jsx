    ...
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-[1440px]">
      <div className="glass-card bg-surface/60 backdrop-blur-2xl rounded-full px-8 py-3 flex justify-between items-center border border-white/10 shadow-2xl">
        ...
        <div className="hidden md:flex gap-10 items-center absolute left-1/2 -translate-x-1/2">
          ...
          <Link to="/attender" className="font-label-md text-label-md text-on-surface-variant tracking-widest uppercase hover:text-white transition-colors">Attender Hub</Link>
          <Link to="/profile" className="font-label-md text-label-md text-on-surface-variant tracking-widest uppercase hover:text-white transition-colors">Profile</Link>
        </div>
