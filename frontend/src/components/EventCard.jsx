...
const EventCard = ({ event, className = '' }) => {
  return (
    <div className={`group relative bg-dark-card rounded-2xl overflow-hidden border border-white/5 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(255,0,127,0.15)] ${className}`}>
      ...
      <div className="p-6 relative z-20">
        <h3 className="text-2xl font-display font-bold text-white mb-2 group-hover:text-neon-pink transition-colors">
          {event.title}
        </h3>
