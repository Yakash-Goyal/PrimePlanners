          ...
          <div className="flex flex-col gap-6 relative z-10">
            ...
            <div className="flex flex-col gap-3 font-body-md text-body-md border-t border-white/10 pt-4">
              ...
              <div className="flex justify-between text-on-surface-variant">
                <span>
                  Service Fee{' '}
                  <span className="text-xs text-primary">(2% platform commission)</span>
                </span>
            ...
            <button
              ...
              className="w-full py-4 mt-2 bg-primary text-white font-headline-md text-headline-md uppercase tracking-wide rounded-xl neon-glow-primary hover:bg-primary-fixed hover:scale-[1.02] transition-all active:scale-95 flex justify-center items-center gap-2"
            >
          ...
          <div className="flex flex-col items-center justify-center py-8 gap-6 relative z-10 animate-in zoom-in duration-500">
            ...
            <div className="w-full bg-surface/50 rounded-xl p-4 border border-white/10 mt-4 flex flex-col items-center gap-2">
              ...
              <p className="text-xs text-on-surface-variant uppercase tracking-widest">
                Booking ID: {bookingId ? bookingId.slice(-8).toUpperCase() : 'CONFIRMED'}
              </p>
            </div>
